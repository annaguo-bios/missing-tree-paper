...
# Source 
source("Simulations/DGPs/dgp-G1sub-causal.R") # DGP
source("Simulations/sim3-causal/G1sub/bd_est.R") # MICE estimation
source("Simulations/sim3-causal/G1sub/est_mice.R") # MICE estimation
source("Simulations/sim3-causal/G1sub/est_em.R") # Amelia estimation
source("Simulations/sim3-causal/G1sub/est_flexmissing.R") # flexMissing estimation
...
plot(G, vertex.size = 15, save=T,file='./Simulations/sim3-causal/G1sub/mDAG.png', width = 12, height = 9, units = "in", res = 300)
ID <- f.ID_algorithm(G,T)
plot(ID,vertex.size = 15, save=T,file='./Simulations/sim3-causal/G1sub/ID.png', width = 12, height = 9, units = "in", res = 300)
...
ggsave("Simulations/sim3-causal/G1sub/plot-sim3-bd.pdf", plot = p_bias, width = 12, height = 8, units = "in")

save(list=c('mice_bias','em_bias','flexmissing_bias','complete_case_bias'),
     file="Simulations/sim3-causal/G1sub/result.Rdata")
