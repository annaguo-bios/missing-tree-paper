...
# Source 
source("Simulations/DGPs/dgp-mar-mean.R") # DGP
source("Simulations/sim1-mean/mar/est_mice.R") # MICE estimation
source("Simulations/sim1-mean/mar/est_em.R") # Amelia estimation
source("Simulations/sim1-mean/mar/est_flexmissing.R") # flexMissing estimation
...
plot(G, vertex.size = 15, save=T,file='./Simulations/sim1-mean/mar/mDAG.png', width = 12, height = 9, units = "in", res = 300)
ID <- f.ID_algorithm(G,T)
plot(ID,vertex.size = 15, save=T,file='./Simulations/sim1-mean/mar/ID.png', width = 12, height = 9, units = "in", res = 300)
...
ggsave("Simulations/sim1-mean/mar/plot-sim1.pdf", plot = p_bias, width = 12, height = 8, units = "in")

save(list=c('mice_bias','em_bias','flexmissing_bias','complete_case_bias'),
     file="Simulations/sim1-mean/mar/result.Rdata")
